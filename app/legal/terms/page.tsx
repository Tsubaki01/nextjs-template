  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-10">
      ...
      <div className="prose prose-gray max-w-none space-y-6">
        <section>
          <p className="text-gray-600">最終更新日: 2024年1月1日</p>
        </section>

        <section>
          <h2 className="mb-4 mt-8 text-xl font-semibold text-gray-900">第1条（適用）</h2>
        ...
        <section>
          <h2 className="mb-4 mt-8 text-xl font-semibold text-gray-900">第2条（利用登録）</h2>
          <p className="leading-relaxed text-gray-700">
        ...
        <section>
          <h2 className="mb-4 mt-8 text-xl font-semibold text-gray-900">第5条（禁止事項）</h2>
        ...
        <section>
          <h2 className="mb-4 mt-8 text-xl font-semibold text-gray-900">第7条（著作権）</h2>
          <p className="leading-relaxed text-gray-700">
        ...
        <section>
          <h2 className="mb-4 mt-8 text-xl font-semibold text-gray-900">第8条（免責事項）</h2>
          <p className="leading-relaxed text-gray-700">
        ...
        <section>
          <h2 className="mb-4 mt-8 text-xl font-semibold text-gray-900">第11条（退会）</h2>
          <p className="leading-relaxed text-gray-700">
