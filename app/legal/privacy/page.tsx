  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-10">
      ...
      <div className="prose prose-gray max-w-none space-y-6">
        ...
        <section>
          <h2 className="mb-4 mt-8 text-xl font-semibold text-gray-900">第1条（個人情報）</h2>
          <p className="leading-relaxed text-gray-700">
        ...
        <section>
          <h2 className="mb-4 mt-8 text-xl font-semibold text-gray-900">第4条（利用目的の変更）</h2>
          <p className="leading-relaxed text-gray-700">
        ...
        <section>
          <h2 className="mb-4 mt-8 text-xl font-semibold text-gray-900">第6条（個人情報の開示）</h2>
          <p className="leading-relaxed text-gray-700">
        ...
        <section>
          <h2 className="mb-4 mt-8 text-xl font-semibold text-gray-900">第8条（個人情報の保護）</h2>
          <p className="leading-relaxed text-gray-700">
